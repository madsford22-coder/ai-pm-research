...
async function main() {
  ...
  const people = allPeople.filter(p => ['Lenny Rachitsky', 'Marty Cagan', 'Shreyas Doshi'].includes(p.name));
  console.log('Testing on', people.length, 'people:', people.map(p => p.name).join(', '));
