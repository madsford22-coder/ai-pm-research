---
title: "Agent Builder GA, Vertex Pricing & Advanced Claude Code Techniques"
date: 2026-01-26
tags:
  - daily-update
  - ai-pm-research
...
LangSmith Agent Builder reaches GA with no-code agents, Google introduces usage-based pricing for agent features, and Lenny's podcast demonstrates advanced Claude Code techniques for preloading context with mermaid diagrams.
...
### Lenny's Podcast - Advanced Claude Code Techniques: Context Loading & Mermaid Diagrams
**Source:** https://www.lennysnewsletter.com/p/advanced-claude-code-techniques-context
**Credibility:** High (detailed walkthrough from egghead.io founder with live demonstrations)

**What happened:** Lenny hosted John Lindquist (egghead.io founder) demonstrating advanced Claude Code techniques for senior engineers. The key insight: using mermaid diagrams to preload system architecture context helps AI coding assistants understand complex codebases faster.

**Key techniques demonstrated:**

- **Mermaid diagrams for context preloading**: Visualize system architecture before requesting code changes—helps AI orient to complex codebases quickly
- **Custom hooks for quality**: Create automated hooks that check for TypeScript errors and only commit working code
- **Command-line aliases**: Build shortcuts that streamline AI workflows for repeated patterns
- **AI-guided codebase exploration**: Use Claude Code to investigate unfamiliar codebases systematically
- **Conversation resets**: Recognize when AI responses diverge and reset to get back on track

**Why it matters for PMs:**
This continues the pattern from Jan 18-19 updates: AI coding tools becoming productivity infrastructure, not just code generators. The mermaid diagram technique is particularly notable—it's a concrete pattern for giving AI tools architectural context. For PMs building with AI coding tools, this suggests investing time in context documentation pays off in AI output quality.

**Critical questions:**
- How much upfront investment in mermaid diagrams is needed before productivity gains kick in?
- Do these techniques scale to larger teams, or are they primarily individual productivity patterns?
- What's the learning curve for non-technical PMs vs. engineers?

**Action you could take today:**
If you use Claude Code, try creating a simple mermaid diagram of one component's architecture before your next coding session. Test whether the AI's code suggestions improve with explicit visual context.
